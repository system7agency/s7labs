...
function prettyConfigJson(raw: string): string {
  try {
...
function buildPlainText(r: BlueprintResult): string {
  return [
                    ...
                    <div ref={resultPanelRef}>
                      <div className="one-liner-block">
                        ...
                        <div className="one-liner-meta">
                          <span className="process-name">{result.process_name}</span>
                          <span className="freq-pill">{result.current_state.frequency}</span>
                        </div>
                        <p className="estimate-note">
                          Time saved figures are estimates, not guarantees.
                        </p>
                      </div>
                      ...
                      <div className="stats-row">
                        <div className="score-card time-saved-card">
                          ...
                          <div className="sc-value">
                            <span className="sc-big">
                              {result.current_state.time_saved_per_week}
                            </span>
                          </div>
                          <div className="sc-delta">
                            {result.current_state.time_saved_per_year}/year
                          </div>
                        </div>
                        <div className="score-card glance-card">
                          ...
                          <div className="stat-grid">
                            <StatMini
                              label="Manual steps"
                              value={String(result.current_state.steps_count)}
                            />
                            <StatMini label="Frequency" value={result.current_state.frequency} />
                            <StatMini
                              label="Difficulty"
                              value={result.difficulty}
                              valueClass={`difficulty-badge ${difficultyClass(result.difficulty)}`}
                            />
                            <StatMini label="Recommended" value={result.recommended_tool} />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="tool-row">
                        {result.tool_options.map((tool) => (
                          <ToolCard
                            key={tool.name}
                            tool={tool}
                            recommended={tool.name === result.recommended_tool}
                          />
                        ))}
                      </div>
                      ...
                      <div className="config-section">
                        ...
                        >
                          <span>{'// starter config'}</span>
                          <span className="config-platform">{result.starter_config.platform}</span>
