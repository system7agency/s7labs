...
function fmtTs(d: Date) {
  ...
  return `STACK · ${d.getUTCFullYear()}-${p(d.getUTCMonth() + 1)}-${p(d.getUTCDate())} · ${p(d.getUTCHours())}:${p(d.getUTCMinutes())} UTC`
}
      ...
      <div className="stack-diagram-body">
        {layers.map((layer, i) => (
          <div key={layer.layer} className="stack-diagram-row">
            ...
            <div className={`stack-layer ${LAYER_ACCENTS[layer.layer] ?? ''}`}>
...
export default function TechStackRecommenderPage() {
  ...
  const handleSubmit = useCallback(
    ...
    [brief, submitting, startLoadingAnimation, clearTimers]
  )
  ...
  return (
    <div className="tech-stack-recommender">
      ...
      <div className="bg-layer bg-spotlight" id="tsr-spotlight" />
      ...
      <main className="shell">
        ...
        <div className="panel-wrap panel-wrap-wide">
          <div className="panel">
            ...
            <div className="panel-body">
              <section className={`tsr-state${appState === 'idle' ? 'active' : ''}`}>
              ...
              <section className={`tsr-state${appState === 'loading' ? 'active' : ''}`}>
              ...
              <section className={`tsr-state${appState === 'result' ? 'active' : ''}`}>
                {result && (
                  <>
              ...
              <section className={`tsr-state error-state${appState === 'error' ? 'active' : ''}`}>
        ...
        <section className="info-strip">
          <div className="dim-card">
            <div className="key">{'// 01 Brief'}</div>
            <div className="name">Plain English in</div>
            <div className="desc">
              Describe the product in a meeting — no technical jargon required upfront.
            </div>
          </div>
          <div className="dim-card">
            <div className="key">{'// 02 Stack'}</div>
            <div className="name">Six core layers</div>
            <div className="desc">
              Frontend through payments, each with a pick, reasoning, alternatives, and cost.
            </div>
          </div>
          <div className="dim-card">
            <div className="key">{'// 03 Screenshot'}</div>
            <div className="name">Architecture card</div>
            <div className="desc">
              A layered diagram designed to export cleanly as PNG for Slack, decks, or proposals.
            </div>
          </div>
          <div className="dim-card">
            <div className="key">{'// 04 Reality check'}</div>
            <div className="name">Honest estimates</div>
            <div className="desc">
              Complexity, build time, and monthly cost at MVP scale — labeled as estimates.
            </div>
          </div>
        </section>
      </main>
