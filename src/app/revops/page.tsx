...
import { SystemisedKnowledgeSection } from './SystemisedKnowledgeSection'
...
// per the new design but kept in the code in case they are wanted back.
      ...
      <main>
        <section className="hero">
          ...
          <p className="hero-subtitle">
            We map and build the RevOps and GTM systems that turn manual work into automation and
            pipeline you can actually predict at scale.
          </p>
